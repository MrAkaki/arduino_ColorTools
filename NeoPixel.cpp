...
NeoPixel::NeoPixel(uint16_t n, uint8_t p, neoPixelType t) :
...
extern "C" void ICACHE_RAM_ATTR espUpdate(
...
void NeoPixel::setPixelColor(uint16_t n,const RGB &c){
  this->setPixelColor(n,c.r,c.g,c.b);
}

void NeoPixel::setPixelColor(uint16_t n, const HSV &c){
  RGB rgb;
  c.toRGB(rgb);
  this->setPixelColor(n,rgb.r,rgb.g,rgb.b);
}
